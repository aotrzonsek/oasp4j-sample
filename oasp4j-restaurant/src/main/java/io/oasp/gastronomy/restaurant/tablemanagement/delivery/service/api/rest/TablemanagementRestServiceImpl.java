package io.oasp.gastronomy.restaurant.tablemanagement.delivery.service.api.rest;
...
public class TablemanagementRestServiceImpl {
  ...
  public void markTableAs(@PathParam("id") Long id, @PathParam("newState") TableState newState) {
    ...
    if (table == null) {
      ...
      this.tableManagement.markTableAs(id, newState);
    }
  }
  ...
  public boolean isTableReleasable(@PathParam("id") Long id) {
    ...
    if (table == null) {
      ...
      return this.tableManagement.isTableReleasable(id);
    }
  }
}
